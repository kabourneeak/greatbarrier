...
/*
 * Checks each page that is completed to see if it should be given "safe" status
 */
chrome.webRequest.onCompleted.addListener(function(info) {
	...
	{
		// if present, register blocking onBeforeRequest
...
var checkBarrier = function(info) {
	...
	else
	{
		...
		console.log("Canceled non-whitelist entry");
...
var registerBarrier = function(info) {
	...
	console.log("Registered tab " + info.tabId);
};

var tabWatcher = function() {

	// watch for new tabs to become opened.  If they are opened by a secure tab,
	// then they should be registered. They might then immediately become cancelled
	// and re-opened in an incognito window
};
